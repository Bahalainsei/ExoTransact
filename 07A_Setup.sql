...
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12018, N'Ruben', N'Torres', N'M', N'ruben35@adventure-works.com', N'5844 Linden Land', NULL, N'1 (11) 500 555-0184')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12019, N'Christy', N'Zhu', N'F', N'christy12@adventure-works.com', N'1825 Village Pl.', NULL, N'1 (11) 500 555-0162')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12020, N'Elizabeth', N'Johnson', N'F', N'elizabeth5@adventure-works.com', N'7553 Harness Circle', NULL, N'1 (11) 500 555-0131')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12021, N'Julio', N'Ruiz', N'M', N'julio1@adventure-works.com', N'7305 Humphrey Drive', NULL, N'1 (11) 500 555-0151')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12022, N'Janet', N'Alvarez', N'F', N'janet9@adventure-works.com', N'2612 Berry Dr', NULL, N'1 (11) 500 555-0184')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12023, N'Marco', N'Mehta', N'M', N'marco14@adventure-works.com', N'942 Brook Street', NULL, N'1 (11) 500 555-0126')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12024, N'Rob', N'Verhoff', N'F', N'rob4@adventure-works.com', N'624 Peabody Road', NULL, N'1 (11) 500 555-0164')
GO
INSERT [dbo].[Customers] ([CustomerKey], [FirstName], [LastName], [Gender], [EmailAddress], [AddressLine1], [AddressLine2], [Phone]) VALUES (12025, N'Shannon', N'Carlson', N'M', N'shannon38@adventure-works.com', N'3839 Northgate Road', NULL, N'1 (11) 500 555-0110')
GO
